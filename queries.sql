...
INSERT INTO tasks(user_id, project_id, dt_created, dt_deadline, name) VALUES (1, 1, CURDATE(), CURDATE()+ INTERVAL 1 DAY, 'Какая-то новая задача1');
/*Получить все задачи для завтрашнего дня*/
SELECT * FROM `tasks` WHERE dt_deadline = CURDATE() + INTERVAL 1 DAY;
